const categories = [
  {
    ...
    items: [
      {
        title: 'MacBook Air M3 (13", 2024)',
        description:
          'The M3 chip is just amazing. Plus, 16 GB RAM, 512 GB SSD, and 8-core GPU.',
        url: 'https://www.apple.com/macbook-air/',
      },
      {
        title: 'MSI 27er Full HD Monitor ',
    ...
    items: [
      {
        ...
        description:
          'Best headphones money can buy. The noise cancellation is just awesome.',
